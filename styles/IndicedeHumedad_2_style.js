...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.059660 && value <= 0.038213) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.038213 && value <= 0.136086) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.136086 && value <= 0.233958) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.233958 && value <= 0.331831) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.331831 && value <= 0.429704) {
            style = [ new ol.style.Style({
