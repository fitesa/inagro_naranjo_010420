...
var style_IndicedeVegetacion_4 = function(feature, resolution){
    ...
    if (value >= 0.185942 && value <= 0.316259) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.316259 && value <= 0.446575) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.446575 && value <= 0.576892) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.576892 && value <= 0.707209) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.707209 && value <= 0.837526) {
            style = [ new ol.style.Style({
