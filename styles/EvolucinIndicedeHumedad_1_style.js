...
var style_EvolucinIndicedeHumedad_1 = function(feature, resolution){
    ...
    if (value >= -0.087402 && value <= -0.030629) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.030629 && value <= 0.026144) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.026144 && value <= 0.082917) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.082917 && value <= 0.139690) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.139690 && value <= 0.196463) {
            style = [ new ol.style.Style({
